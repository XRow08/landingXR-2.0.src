...
export function About() {
  ...
  return (
    <div className="bg-about bg-no-repeat bg-cover w-screen h-screen">
      <Sidebar />
        ...
        <Container className="flex flex-row justify-center gap-12 w-3/5 h-2/4 self-center">
          ...
          <div data-aos="fade-right" className="w-full">
            {active && (
              <Description
                children={
                  'SOMOS UMA AGÊNCIA QUE ATUA NA ÁREA DE DESIGN E NO DESENVOLVIMENTO DE SOFTWARES WEB2 E WEB3 COMO SISTEMA DE PDV, WEBSITE, LANDING PAGE, GESTÃO FINANCEIRA, CONTRATO INTELIGENTE, BLOCKCHAIN E MUITO MAIS. ATUAMOS NO MERCADO DESDE 2020, COM MAIS DE 50 CLIENTES SATISFEITOS, ALÉM DE DIVERSOS PROJETOS DESENVOLVIDOS ENTREGUES.'
                }
                color={'black'}
              />
            )}
